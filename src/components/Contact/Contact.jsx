    ...
    >
      <div className="section-inner">
        ...
        <div className={styles.layout}>
          ...
          {/* Columna derecha: FORM como terminal */}
            ...
            >
              <div className={styles.row}>
                <div className={styles.formGroup}>
                  <label htmlFor="firstName">
                    <span className={styles.prompt}>$</span> first_name
                  </label>
                  <input
                    id="firstName"
                    type="text"
                ...
                <div className={styles.formGroup}>
                  <label htmlFor="lastName">
                    <span className={styles.prompt}>$</span> last_name
                  </label>
                  <input
                    id="lastName"
                    type="text"
              ...
              <div className={styles.formGroup}>
                <label htmlFor="message">
                  <span className={styles.prompt}>$</span> message
                </label>
                <textarea
                  id="message"
                  name="message"
                  placeholder="Describe your project, timelines and expectations..."
                  required
                  onChange={handleInputChange}
                />
              </div>
